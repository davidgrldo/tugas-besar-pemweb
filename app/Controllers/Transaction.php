...
class Transaction extends Controller
{
    ...
    {
        helper(['form']);
        $this->MsTransaction = new MsTransaction();
        $this->MsProduct = new MsProduct();
    }

    public function index()
    {
        $data['transactions'] = $this->MsTransaction->getTransaction();
    ...
    public function proses_import()
    {
        ...
        if($validation->run($data, 'transaction') == FALSE){
            ...
            foreach($data as $idx => $row){
                ...
                $simpan = $this->MsTransaction->insertTransaction($data);
            }
    ...
    {
        $price = $this->MsProduct->getPrice($product_id);
    ...
    {
        $transactions = $this->MsTransaction->getTransaction();
